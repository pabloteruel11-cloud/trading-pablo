...
window.ACTIVOS = {
  ...
  activos: [
    ...
    { id: 'msci-em', nombre: 'MSCI Emerging Markets', categoria: 'indices', isin: null, ticker: 'MSCI EM', moneda: 'USD', sri: 5,
      ...
      returnType: 'total_return_anual_pct', serie: [],
      fuente: 'MSCI — Index Factsheet (MSCI Emerging Markets)', fuenteUrl: 'https://www.msci.com/indexes/index/891800', fechaConsulta: '2026-06-23', status: 'pendiente' },
    ...
    { id: 'msci-acwi', nombre: 'MSCI ACWI (mundo entero)', categoria: 'indices', isin: null, ticker: 'MSCI ACWI', moneda: 'USD', sri: 4,
      descripcion: 'Todo el mundo invertible: desarrollados + emergentes (~2.600 empresas). El índice global más completo.',
      returnType: 'total_return_anual_pct', serie: [],
      fuente: 'MSCI — Index Factsheet (MSCI ACWI)', fuenteUrl: 'https://www.msci.com/indexes/index/892400', fechaConsulta: '2026-06-23', status: 'pendiente' },
    ...
    { id: 'vwce', nombre: 'Vanguard FTSE All-World Acc (VWCE)', categoria: 'etfs', isin: 'IE00BK5BQT80', ticker: 'VWCE', moneda: 'USD', sri: 4,
      ...
      returnType: 'total_return_anual_pct', serie: [],
      fuente: 'Vanguard — FTSE All-World UCITS ETF (Acc)', fuenteUrl: 'https://www.justetf.com/en/etf-profile.html?isin=IE00BK5BQT80', fechaConsulta: '2026-06-23', status: 'pendiente' },
    { id: 'emim', nombre: 'iShares Core MSCI EM IMI (EMIM)', categoria: 'etfs', isin: 'IE00BKM4GZ66', ticker: 'EMIM', moneda: 'USD', sri: 5,
      descripcion: 'ETF de mercados emergentes (China, India, Taiwán, Brasil...). La parte "emergente" de una cartera global. TER ~0,18%.',
      returnType: 'total_return_anual_pct', serie: [],
      fuente: 'iShares — Core MSCI EM IMI UCITS ETF', fuenteUrl: 'https://www.justetf.com/en/etf-profile.html?isin=IE00BKM4GZ66', fechaConsulta: '2026-06-23', status: 'pendiente' },
